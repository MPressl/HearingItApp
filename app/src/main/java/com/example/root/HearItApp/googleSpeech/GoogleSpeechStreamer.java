...
public class GoogleSpeechStreamer implements Runnable{


    private GoogleRecorder parent;
...
//    private ManagedChannel channel;
    ...
    public GoogleSpeechStreamer(GoogleRecorder parent){
        this.parent = parent;
    }
...
*/
    ...
    public void makeToast(String msg){
        parent.getMainView().showToast(msg);
    }
